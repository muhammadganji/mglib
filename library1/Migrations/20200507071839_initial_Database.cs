        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateTimeRequest = table.Column<string>(nullable: true),
                    DateTimeConfirmAdmin = table.Column<string>(nullable: true),
                    DateTimeGiveBack = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    newsConten = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TransactonDate = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookStock = table.Column<int>(nullable: false),
                    BookViews = table.Column<int>(nullable: false),
                    Image = table.Column<string>(nullable: true),
                    BookLikeCount = table.Column<int>(nullable: false),
                    AuthorID = table.Column<int>(nullable: false),
                    BookGroupID = table.Column<int>(nullable: false),
                    Price = table.Column<int>(nullable: false)
                },
